...
Broad limitations of the current system and the directions to harden it before/at production
scale. Grouped by area; not in strict priority order. (Decision history for shipped items is
