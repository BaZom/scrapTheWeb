...
- **[browser-extension.md](browser-extension.md)** — "Skrowt relocated": run the visual sprout in the user's own browser to reach fortress/login sites without evasion (ADR 0012).
